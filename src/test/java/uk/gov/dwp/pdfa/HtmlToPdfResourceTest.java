...
public class HtmlToPdfResourceTest {
  private static final String FULL_JSON =
      "{\"font_map\": {\"tahoma\":\"base64-string\",\"arial\":\"base64-string\"}, \"colour_profile\": \"base64-string\", \"page_html\": \"base64-html\", \"conformance_level\": \"PDFA_1_A\"}";
  private static final String BAD_CONFORMANCE_LEVEL =
      "{\"font_map\": {\"tahoma\":\"base64-string\",\"arial\":\"base64-string\"}, \"colour_profile\": \"base64-string\", \"page_html\": \"base64-html\", \"conformance_level\": \"BAD_PDF_1\"}";
  private static final String MISSING_CONFORMANCE_LEVEL =
      "{\"font_map\": {\"tahoma\":\"base64-string\",\"arial\":\"base64-string\"}, \"colour_profile\": \"base64-string\", \"page_html\": \"base64-html\"}";
  private static final String MISSING_COLOUR_PROFILE =
      "{\"font_map\": {\"tahoma\":\"base64-string\",\"arial\":\"base64-string\"}, \"page_html\": \"base64-html\", \"conformance_level\": \"PDFA_1_A\"}";
  private static final String MISSING_FONT_MAP =
      "{\"colour_profile\": \"base64-string\", \"page_html\": \"base64-html\", \"conformance_level\": \"PDFA_1_A\"}";

  @Mock private HtmlToPdfGenerator htmlToPdfGenerator;

  @Captor private ArgumentCaptor<String> colourProfileCapture;

  @Captor private ArgumentCaptor<Map<String, String>> fontMapCapture;

  @Captor private ArgumentCaptor<String> conformanceLevelCapture;
  ...
  public void testSuccessWithAllParameters() throws IOException, PdfaGeneratorException {
    ...
    when(htmlToPdfGenerator.createPdfaDocument(
  ...
  public void testPDFUAWithMissingInputConformance() throws IOException, PdfaGeneratorException {
    ...
    assertThat(Base64.getDecoder().decode(pdfa.getEntity().toString()), is(equalTo(returningPdf)));
    assertThat(
        conformanceLevelCapture.getValue(), is(equalTo(PdfExtendedConstants.PDF_UA_CONFORMANCE)));
  }

  @Test
  public void testRejectionWithInvalidConformance() throws IOException, PdfaGeneratorException {
    when(htmlToPdfGenerator.createPdfaDocument(anyString(), anyString(), anyMap(), anyString()))
        .thenThrow(new PdfaGeneratorException("i-am-exception"));
    HtmlToPdfResource instance = new HtmlToPdfResource(htmlToPdfGenerator);
