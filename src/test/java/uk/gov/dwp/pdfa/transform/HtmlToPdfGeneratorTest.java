...
public class HtmlToPdfGeneratorTest {
  ...
  public static void init() throws IOException {
    defaultColourProfile =
        Base64.getEncoder()
            .encodeToString(
                IOUtils.toByteArray(
                    HtmlToPdfGeneratorTest.class.getResourceAsStream("/colours/sRGB.icm")));
    htmlFile =
        Base64.getEncoder()
            .encodeToString(
                FileUtils.readFileToByteArray(new File("src/test/resources/successfulHtml.html")));
    ...
    defaultFontMap.put(
        ...
        Base64.getEncoder()
            .encodeToString(
                IOUtils.toByteArray(
                    HtmlToPdfGeneratorTest.class.getResourceAsStream("/fonts/courier.ttf"))));
    defaultFontMap.put(
        "arial",
        Base64.getEncoder()
            .encodeToString(
                IOUtils.toByteArray(
                    HtmlToPdfGeneratorTest.class.getResourceAsStream("/fonts/arial.ttf"))));
  }
  ...
  @Test
  public void successfullyCreatePdfaBasic()
      throws IOException, PdfaGeneratorException, XmpParsingException, XMPException {
    String base64pdf =
  ...
  @Test
  public void successfullyCreateAccessiblePdfUA()
      throws IOException, PdfaGeneratorException, XmpParsingException, XMPException {
    String accessibleHtml =
        Base64.getEncoder()
            .encodeToString(
                FileUtils.readFileToByteArray(new File("src/test/resources/accessible-test.html")));
  ...
  public void failWithNullConformanceLevel() {
    try {
      instance.createPdfaDocument(
          Base64.getEncoder().encodeToString("bad-conformance".getBytes()),
          defaultColourProfile,
          defaultFontMap,
          null);
  ...
  public void failWithDuffConformanceLevel() {
    try {
      ...
      assertThat(
          e.getMessage(), is(equalTo("'PDF_A99' is not a valid conformance level, aborting")));
    }
  }

  @Test
  public void successfullyCreatePdfaBMultiPage()
      throws IOException, PdfaGeneratorException, XmpParsingException, XMPException {
    String base64File =
        Base64.getEncoder()
            .encodeToString(
                FileUtils.readFileToByteArray(new File("src/test/resources/pageBreaksHtml.html")));
    String base64pdf =
        instance.createPdfaDocument(
            base64File,
            defaultColourProfile,
          ...
          Base64.getEncoder()
              .encodeToString(
                  FileUtils.readFileToByteArray(
                      new File("src/test/resources/noFontSupplied.html"))),
          defaultColourProfile,
          defaultFontMap,
          PdfRendererBuilder.PdfAConformance.PDFA_1_A.toString());
  ...
  @Test
  public void incorrectFormatWithBadImageRenderingInHtml()
      throws IOException, PdfaGeneratorException, XmpParsingException, XMPException {
    String base64pdf =
        instance.createPdfaDocument(
            Base64.getEncoder()
                .encodeToString(
                    FileUtils.readFileToByteArray(
                        new File("src/test/resources/imageFailureHtml.html"))),
            defaultColourProfile,
            defaultFontMap,
            PdfRendererBuilder.PdfAConformance.PDFA_1_A.toString());
  ...
  @Test
  public void changeConformanceLevelIsHandled()
      throws IOException, PdfaGeneratorException, XmpParsingException, XMPException {
    String base64pdf =
        instance.createPdfaDocument(
            htmlFile,
            defaultColourProfile,
            defaultFontMap,
            PdfRendererBuilder.PdfAConformance.PDFA_1_B.toString());
    PDDocument pdfDoc = PDDocument.load(Base64.getDecoder().decode(base64pdf));
  ...
  @Test
  public void testSuccessWithOverrideFontForArial()
      throws IOException, PdfaGeneratorException, XmpParsingException, XMPException {
    defaultFontMap.replace(
        "arial",
        Base64.getEncoder()
            .encodeToString(
                IOUtils.toByteArray(getClass().getResourceAsStream("/fonts/arialbd.ttf"))));
  ...
  public void testFailureWithBadHtml() throws IOException {
    try {
      ...
      instance.createPdfaDocument(
          Base64.getEncoder()
              .encodeToString(
                  FileUtils.readFileToByteArray(new File("src/test/resources/badHtmlFile.html"))),
          defaultColourProfile,
          defaultFontMap,
          PdfRendererBuilder.PdfAConformance.PDFA_1_A.toString());
      fail("should have thrown an error");
  ...
  public void testFailureWithNullFontOverride() {
    try {
      instance.createPdfaDocument(
          htmlFile, defaultColourProfile, null, PdfRendererBuilder.PdfAConformance.NONE.toString());
      fail("should have thrown an error");

    } catch (PdfaGeneratorException e) {
      assertThat(
          e.getCause().getClass().getName(), is(equalTo(NullPointerException.class.getName())));
    }
  }

  @Test
  public void testSuccessWithBadlyNamedFontOverrideIsOkOnNone()
      throws IOException, PdfaGeneratorException {
    Map<String, String> fontMap = new HashMap<>();
    fontMap.put(
        "aaarial",
        Base64.getEncoder()
  ...
  @Test
  public void testSuccessWithOverrideColourProfile()
      throws IOException, XmpParsingException, PdfaGeneratorException, XMPException {
  ...
  public void testFailureWithBadColourProfileOverride() {
    try {
      instance.createPdfaDocument(
          htmlFile,
          Base64.getEncoder().encodeToString("i-am-a-colour-profile".getBytes()),
          defaultFontMap,
          PdfRendererBuilder.PdfAConformance.PDFA_1_A.toString());
      fail("should have thrown an error");
  ...
  private void validateDocumentConformance(PDDocument pdfDoc, String conformance)
      throws IOException, XMPException, XmpParsingException {
